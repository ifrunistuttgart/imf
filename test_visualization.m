...
%%
% Transformation from System 2 to System 1
T23 = imf.Transformation(c2,c1);
T23.rotation = imf.DCM.T2(q2);
% The offset of the origin of System 2 to System 1
% with regards to System 1
T23.offset = imf.Vector(l*[sin(-q2);0;cos(-q2)]);
...
m.Add(imf.Mass('m3', m3, [sin(-q3)*l,0,cos(-q3)*l]', c2));
